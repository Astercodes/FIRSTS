...
const STAGE_ONE_FIRSTS: FirstModule[] = [
  { id: 1, code: "01", stage: "one", title: "Core Values Audit", category: "A", time: "45 to 60 min", difficulty: "Moderate", status: "complete", thoroughness: 2, lastUpdated: "3 months ago" },
  { id: 2, code: "02", stage: "one", title: "Career Vision", category: "A", time: "2 to 3 hrs", difficulty: "Moderate", status: "complete", thoroughness: 2, lastUpdated: "14 months ago", dueForReview: true },
  { id: 3, code: "03", stage: "one", title: "Personal Purpose Awareness", category: "A", time: "45 to 60 min", difficulty: "Deep", status: "complete", thoroughness: 3, lastUpdated: "3 months ago" },
  ...
  { id: 5, code: "05", stage: "one", title: "Strength Inventory", category: "A", time: "1 to 2 hrs", difficulty: "Easy", status: "complete", thoroughness: 1 },
  { id: 6, code: "06", stage: "one", title: "Weakness Awareness", category: "A", time: "1 to 2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 7, code: "07", stage: "one", title: "Passion Alignment", category: "A", time: "2 to 3 hrs", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 8, code: "08", stage: "one", title: "Industry Insight", category: "B", time: "2 to 4 hrs", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  { id: 9, code: "09", stage: "one", title: "Career Path", category: "B", time: "2 to 4 hrs", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  { id: 10, code: "10", stage: "one", title: "Role Research", category: "B", time: "4 to 8 hrs", difficulty: "Deep", status: "complete", thoroughness: 1 },
  { id: 11, code: "11", stage: "one", title: "Salary Benchmarking", category: "B", time: "1 to 2 hrs", difficulty: "Easy", status: "complete", thoroughness: 2 },
  { id: 12, code: "12", stage: "one", title: "Career SWOT Analysis", category: "C", time: "45 to 60 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 13, code: "13", stage: "one", title: "Skill Growth Plan", category: "C", time: "45 to 60 min", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  { id: 14, code: "14", stage: "one", title: "Personality Assessment", category: "D", time: "2 to 3 hrs", difficulty: "Moderate", status: "complete", thoroughness: 3 },
...
const STAGE_TWO_FIRSTS: FirstModule[] = [
  { id: 19, code: "B1", stage: "two", title: "Professional Introduction", category: "E", time: "1 to 1.5 hrs", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 22, code: "B4", stage: "two", title: "Professional Communication Style", category: "E", time: "3 to 4 wks", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 25, code: "B7", stage: "two", title: "Personal Brand Strategy", category: "F", time: "2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 28, code: "B10", stage: "two", title: "Professional Image Audit", category: "F", time: "1 to 2 hrs", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 31, code: "B13", stage: "two", title: "LinkedIn Profile", category: "G", time: "3 to 4 hrs", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 34, code: "B16", stage: "two", title: "Digital Footprint Audit", category: "G", time: "2 to 3 hrs", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 37, code: "B19", stage: "two", title: "Professional Headshot", category: "G", time: "1 hr", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 40, code: "B22", stage: "two", title: "Professional Email Template", category: "H", time: "1 to 2 hrs", difficulty: "Easy", status: "complete", thoroughness: 1 },
  ...
  { id: 43, code: "B25", stage: "two", title: "Professional Listening Skill", category: "H", time: "Several wks", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 46, code: "B28", stage: "two", title: "Thoughtful Social Media Presence", category: "I", time: "1 hr setup", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 49, code: "B31", stage: "two", title: "Blog/Article Post", category: "I", time: "3 to 5 hrs", difficulty: "Deep", status: "complete", thoroughness: 3 },
  ...
  { id: 52, code: "B34", stage: "two", title: "Professional Conversation Starter", category: "I", time: "30 to 60 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
...
const STAGE_THREE_FIRSTS: FirstModule[] = [
  { id: 59, code: "C1", stage: "three", title: "Job Application Tracker", category: "K", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 63, code: "C5", stage: "three", title: "Job Listing Analysis", category: "K", time: "10 to 15 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 67, code: "C9", stage: "three", title: "Case/Problem-Solving Prep", category: "L", time: "3 to 4 wks", difficulty: "Deep", status: "complete", thoroughness: 2 },
  ...
  { id: 71, code: "C13", stage: "three", title: "Test/Assessment Prep", category: "L", time: "3 to 5 hrs", difficulty: "Moderate", status: "complete", thoroughness: 2 },
...
const STAGE_FOUR_FIRSTS: FirstModule[] = [
  { id: 79, code: "E1", stage: "four", title: "Confidence Routine", category: "N", time: "15 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 90, code: "E12", stage: "four", title: "Accountability Partner", category: "N", time: "5 to 15 min", difficulty: "Easy", status: "complete", thoroughness: 1 },
...
const STAGE_FIVE_FIRSTS: FirstModule[] = [
  { id: 104, code: "G1", stage: "five", title: "Mental Model Awareness", category: "P", time: "1 hr", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 107, code: "G4", stage: "five", title: "Decision Matrix", category: "P", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 110, code: "G7", stage: "five", title: "Hypothesis Testing", category: "P", time: "1 to 2 wks", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 113, code: "G10", stage: "five", title: "Systems Thinking Exercise", category: "P", time: "45 min to 1 hr", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 116, code: "G13", stage: "five", title: "Mental Model Application", category: "P", time: "30 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 119, code: "H16", stage: "five", title: "SWOT Thinking Exercise", category: "Q", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 122, code: "H19", stage: "five", title: "Opportunity Cost Exercise", category: "Q", time: "15 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 125, code: "H22", stage: "five", title: "Decision Tree Exercise", category: "Q", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 1 },
...
const STAGE_SIX_FIRSTS: FirstModule[] = [
  { id: 134, code: "I1", stage: "six", title: "Professional Email Sent", category: "R", time: "15 to 20 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 140, code: "I18", stage: "six", title: "Business Proposal Drafted", category: "R", time: "1 to 2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 146, code: "I44", stage: "six", title: "Written Proposal Feedback", category: "R", time: "30 min + revision", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 152, code: "I4", stage: "six", title: "Presentation Delivered", category: "S", time: "30 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 158, code: "I23", stage: "six", title: "Debate Participation", category: "S", time: "1 hr prep + debate", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 164, code: "I63", stage: "six", title: "Peer Learning Circle Presentation", category: "S", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 170, code: "I35", stage: "six", title: "Reading List for Career Growth", category: "T", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 1 },
  ...
  { id: 176, code: "I16", stage: "six", title: "Discussion Facilitation", category: "U", time: "Ongoing", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 182, code: "I45", stage: "six", title: "Meeting Facilitation in Class/Group", category: "U", time: "Ongoing", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 188, code: "I25", stage: "six", title: "Professional Feedback Given", category: "V", time: "10 to 15 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
...
const STAGE_SEVEN_FIRSTS: FirstModule[] = [
  { id: 204, code: "K1", stage: "seven", title: "Spreadsheet Mastery", category: "X", time: "2 to 3 hrs", difficulty: "Easy", status: "complete", thoroughness: 3 },
  { id: 205, code: "K2", stage: "seven", title: "Data Analysis Exercise", category: "X", time: "45 min", difficulty: "Easy", status: "locked" },
  { id: 206, code: "K9", stage: "seven", title: "Survey/Questionnaire Designed", category: "X", time: "30 to 45 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  { id: 207, code: "K10", stage: "seven", title: "Statistical Insight Extracted", category: "X", time: "30 min", difficulty: "Easy", status: "locked" },
  { id: 208, code: "K26", stage: "seven", title: "KPI/Metric Measurement", category: "X", time: "15 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 210, code: "K45", stage: "seven", title: "Benchmarking Exercise", category: "X", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 212, code: "K53", stage: "seven", title: "Data Cleaning Exercise", category: "X", time: "Time varies significantly with data messiness", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 213, code: "K62", stage: "seven", title: "Collaborative Spreadsheet", category: "X", time: "20 min", difficulty: "Easy", status: "locked" },
  { id: 214, code: "K64", stage: "seven", title: "Survey Analysis Conducted", category: "X", time: "45 min", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 216, code: "K73", stage: "seven", title: "Data Interpretation Report", category: "X", time: "45 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 217, code: "K81", stage: "seven", title: "Performance Metric Tracked", category: "X", time: "5 min", difficulty: "Easy", status: "locked" },
  { id: 218, code: "K84", stage: "seven", title: "Critical Thinking Applied to Data", category: "X", time: "20 to 30 min", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  { id: 219, code: "K4", stage: "seven", title: "Report Written", category: "Y", time: "Several hours", difficulty: "Moderate", status: "locked" },
  { id: 220, code: "K8", stage: "seven", title: "Research Summary", category: "Y", time: "1 to 2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 222, code: "K16", stage: "seven", title: "Written Executive Summary", category: "Y", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 224, code: "K33", stage: "seven", title: "Online Research Exercise", category: "Y", time: "5 to 10 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  { id: 225, code: "K36", stage: "seven", title: "Technical Template Created", category: "Y", time: "1 hr", difficulty: "Moderate", status: "locked" },
  { id: 226, code: "K42", stage: "seven", title: "Research Presentation", category: "Y", time: "Several hours", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 228, code: "K58", stage: "seven", title: "Documentation for Others Created", category: "Y", time: "1 hr", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 230, code: "K67", stage: "seven", title: "Process Documentation for Team", category: "Y", time: "1 to 2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 232, code: "K5", stage: "seven", title: "Project Plan Drafted", category: "Z", time: "30 to 60 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 233, code: "K6", stage: "seven", title: "Meeting Agenda Prepared", category: "Z", time: "15 min", difficulty: "Easy", status: "locked" },
  { id: 234, code: "K7", stage: "seven", title: "Budget/Expense Sheet Prepared", category: "Z", time: "30 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 236, code: "K12", stage: "seven", title: "Risk Assessment", category: "Z", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 237, code: "K23", stage: "seven", title: "Project Tracking Log Maintained", category: "Z", time: "10 min", difficulty: "Easy", status: "locked" },
  { id: 238, code: "K27", stage: "seven", title: "Process Improvement Proposal", category: "Z", time: "30 min", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 240, code: "K38", stage: "seven", title: "Problem-Solving Checklist", category: "Z", time: "20 min", difficulty: "Easy", status: "complete", thoroughness: 1 },
  ...
  { id: 242, code: "K57", stage: "seven", title: "Workflow Optimization Exercise", category: "Z", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  { id: 243, code: "K66", stage: "seven", title: "Workflow Checklist", category: "Z", time: "15 to 20 min", difficulty: "Easy", status: "locked" },
  { id: 244, code: "K70", stage: "seven", title: "Multi-Step Project Plan Executed", category: "Z", time: "Time varies significantly with project scope", difficulty: "Deep", status: "complete", thoroughness: 3 },
  ...
  { id: 246, code: "K74", stage: "seven", title: "Task Delegation Exercise", category: "Z", time: "Ongoing practice", difficulty: "Moderate", status: "complete", thoroughness: 2 },
  ...
  { id: 248, code: "K88", stage: "seven", title: "Problem Prioritization Exercise", category: "Z", time: "15 to 20 min", difficulty: "Easy", status: "complete", thoroughness: 3 },
  { id: 249, code: "K89", stage: "seven", title: "Project Closure Documented", category: "Z", time: "20 to 30 min", difficulty: "Easy", status: "locked" },
  { id: 250, code: "K3", stage: "seven", title: "Presentation Deck Created", category: "AA", time: "1 to 2 hrs", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 252, code: "K31", stage: "seven", title: "Data Visualization", category: "AA", time: "20 to 30 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 254, code: "K34", stage: "seven", title: "Digital Presentation Recording", category: "AA", time: "1 hr", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  { id: 255, code: "K35", stage: "seven", title: "Infographic Designed", category: "AA", time: "1 hr", difficulty: "Moderate", status: "locked" },
  { id: 256, code: "K39", stage: "seven", title: "Mind Map Created", category: "AA", time: "20 to 30 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 258, code: "K59", stage: "seven", title: "Digital Portfolio Item Created", category: "AA", time: "1 hr", difficulty: "Moderate", status: "complete", thoroughness: 3 },
  ...
  { id: 260, code: "K75", stage: "seven", title: "Visual Project Timeline Created", category: "AA", time: "30 to 45 min", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  { id: 261, code: "K79", stage: "seven", title: "Online Portfolio Update", category: "AA", time: "30 to 45 min", difficulty: "Easy", status: "locked" },
  { id: 262, code: "K87", stage: "seven", title: "Digital Presentation Shared Online", category: "AA", time: "15 to 20 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 264, code: "K14", stage: "seven", title: "Digital Collaboration Tool Used", category: "BB", time: "A few hours of genuine use to build comfort", difficulty: "Easy", status: "complete", thoroughness: 3 },
  { id: 265, code: "K15", stage: "seven", title: "Calendar/Time Management System", category: "BB", time: "15 min", difficulty: "Easy", status: "locked" },
  { id: 266, code: "K20", stage: "seven", title: "Basic Coding or Logic Exercise", category: "BB", time: "1 to 2 hrs", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 268, code: "K40", stage: "seven", title: "Resource Library Organized", category: "BB", time: "1 hr", difficulty: "Easy", status: "complete", thoroughness: 3 },
  ...
  { id: 270, code: "K47", stage: "seven", title: "Task Automation Attempted", category: "BB", time: "Varies with the specific automation", difficulty: "Moderate", status: "complete", thoroughness: 1 },
  ...
  { id: 272, code: "K52", stage: "seven", title: "Time-Tracking System Used", category: "BB", time: "5 min", difficulty: "Easy", status: "complete", thoroughness: 2 },
  ...
  { id: 274, code: "K61", stage: "seven", title: "Online Tool Certification Attempted", category: "BB", time: "Several weeks", difficulty: "Deep", status: "complete", thoroughness: 3 },
