...
const NAV = [
  ...
  { label: "Stage Eight", href: "/dashboard/stage/eight", icon: LayersIcon },
  { label: "Stage Nine", href: "/dashboard/stage/nine", icon: LayersIcon },
  { label: "Stage Ten", href: "/dashboard/stage/ten", icon: LayersIcon },
  { label: "Stage Eleven", href: "/dashboard/stage/eleven", icon: LayersIcon },
  { label: "Stage Twelve", href: "/dashboard/stage/twelve", icon: LayersIcon },
  { label: "Stage Thirteen", href: "/dashboard/stage/thirteen", icon: LayersIcon },
  { label: "Stage Fourteen", href: "/dashboard/stage/fourteen", icon: LayersIcon },
  { label: "Stage Fifteen", href: "/dashboard/stage/fifteen", icon: LayersIcon },
  { label: "Stage Sixteen", href: "/dashboard/stage/sixteen", icon: LayersIcon },
