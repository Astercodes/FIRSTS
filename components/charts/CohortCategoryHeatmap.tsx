...
import type { CategoryWeakSpotRow } from "@/lib/cohortData";

export function CohortCategoryHeatmap({ rows }: { rows: CategoryWeakSpotRow[] }) {
              ...
              return (
                <div key={key} className="group relative">
                  <div
                    tabIndex={0}
                    role="img"
                    aria-label={`${c.label}: cohort average ${c.pct}%`}
