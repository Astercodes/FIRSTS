  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        >
          Give every student a structure for becoming.
        </motion.h1>
        ...
        >
          One platform. One developmental framework. Multiple pathways.
        </motion.p>
        ...
        >
          Students arrive with different levels of clarity, confidence,
          experience, and preparation. FIRSTS gives institutions a shared
          development infrastructure that helps every one of them build
          the knowledge, skills, habits, relationships, and evidence they
          need for where they are going.
        </motion.p>
        ...
        >
          <Link
            ...
            style={{
              background:
                "linear-gradient(100deg, var(--berry-burst), var(--juicy-plum) 60%, var(--fuchsia-blast))",
            }}
          >
            Request a Demo
          </Link>
