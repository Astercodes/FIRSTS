  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-2xl flex-col items-center text-center">
        ...
        >
          Your career doesn&apos;t begin with a job application.
        </motion.h1>
        ...
        >
          It begins with understanding what is possible, discovering where
          you could fit, building what you need, gaining experience, and
          learning how to pursue opportunities intentionally.
        </motion.p>
        ...
        >
          <Link
            ...
            style={{
              background:
                "linear-gradient(100deg, var(--sunshine-orange), var(--neon-pink) 60%, var(--fuchsia-blast))",
            }}
          >
            Explore Careers
          </Link>
