  ...
  return (
    <section id="get-started" className="relative overflow-hidden px-6 py-28">
      <div
        ...
        style={{
          background:
            "linear-gradient(120deg, var(--juicy-plum), var(--berry-burst) 45%, var(--neon-pink) 80%, var(--fuchsia-blast))",
        }}
      />
      ...
      <Reveal className="relative mx-auto flex max-w-2xl flex-col items-center text-center text-paper">
        ...
        <p className="mt-5 max-w-lg text-[15px] leading-relaxed text-paper/85">
          Your students need room to explore. Your advisors need
          visibility. Your institution needs evidence. And your career
          center needs tools that help a limited team support more people
          without turning development into surveillance.
        </p>
        <p className="mt-5 font-display text-lg font-semibold">
          See who is engaging. See where momentum is breaking. Step in
